        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          ...
          <div className="flex flex-col items-center sm:items-start">
            ...
            <p className="text-lg text-gray-700 text-center sm:text-left mb-6 font-medium">
              Des jeux amusants pour les petits explorateurs !
            </p>
          </div>
            ...
            <ul className="space-y-3">
              <li>
                ...
                >
                  ...
                  <span className="transform group-hover:translate-x-1 transition-transform duration-300">Accueil</span>
                </Link>
              </li>
              <li>
                <Link 
                ...
                >
                  ...
                  <span className="transform group-hover:translate-x-1 transition-transform duration-300">Jeux</span>
                </Link>
              </li>
              <li>
                <Link 
                ...
                >
                  ...
                  <span className="transform group-hover:translate-x-1 transition-transform duration-300">Mes Scores</span>
                </Link>
              </li>
              <li>
                <Link 
                ...
                >
                  ...
                  <span className="transform group-hover:translate-x-1 transition-transform duration-300">Mes Étoiles</span>
                </Link>
              </li>
            </ul>
          </div>
            ...
            <ul className="space-y-3">
              <li>
                ...
                >
                  ...
                  <span className="transform group-hover:translate-x-1 transition-transform duration-300">Confidentialité</span>
                </Link>
              </li>
              <li>
                <Link 
              ...
              <li>
                ...
                >
                  ...
                  <span className="transform group-hover:translate-x-1 transition-transform duration-300">Aide</span>
                </Link>
              </li>
            </ul>
          </div>
          ...
          <div className="flex flex-col items-center sm:items-start">
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <span className="transform group-hover:translate-x-1 transition-transform duration-300">contact@sebi.fr</span>
              </a>
        ...
        <div className="relative">
          ...
          <div className="pt-6 text-center">
            <p className="text-gray-600 font-medium">
              © {new Date().getFullYear()} Sebi - Créé avec ❤️ pour les enfants curieux
            </p>
          </div>
        </div>
      </div>
